...
var RowRenderer = Class.extend({
	...
	// Also applies the "intro" and "outro" cells, which are specified by the subclass and templates.
...
var View = fc.View = Class.extend({
	...
	function getViewSpec(requestedViewType) {
		...
		var hash = options.views || {}; // the `templates` option object
		...
		while (viewType && !viewClass) {
			...
			processSpecInput(fcViews[viewType]); // $.fullCalendar.templates, lower precedence
	...
	function zoomTo(newDate, viewType) {
		...
		if (!viewType || !isValidViewType(viewType)) { // a general view name, or "auto"
			...
			viewStr = header.getViewsWithButtons().join(' '); // space-separated string of all the templates in the header
